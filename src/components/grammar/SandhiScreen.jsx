...
import { sandhiData } from '../../data/sandhiData';

/**
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 * 🔮 Sandhi Screen
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 * Displays the Sandhi concept with visual breakdown.
...
const SandhiScreen = () => {
  ...
  return (
    <div style={containerStyles}>
      <Header title={t('home.features.sandhi')} showBack={true} />
      ...
      <div style={contentStyles} className="hide-scrollbar">
        ...
        <p style={descriptionStyles}>
          {sandhiData.description}
        </p>

        {/* Concept Badge */}
        <div style={{ textAlign: 'center' }}>
          <span style={conceptBadgeStyles}>
            Concept: {sandhiData.concept}
          </span>
        </div>
          ...
          <div style={exampleContainerStyles}>
            ...
            <div style={equationStyles}>
              <div style={wordBoxStyles}>
                <span style={sanskritWordStyles}>
                  {sandhiData.example.part1}
                </span>
              </div>

              <span style={symbolStyles}>
                {sandhiData.example.symbol}
              </span>

              <div style={wordBoxStyles}>
                <span style={sanskritWordStyles}>
                  {sandhiData.example.part2}
                </span>
              </div>
            </div>
            ...
            <div style={resultBoxStyles}>
              <span style={resultWordStyles}>
                {sandhiData.example.result}
              </span>
            </div>

            {/* Rule Tag */}
            <span style={ruleTagStyles}>
              {sandhiData.example.rule}
            </span>
          </div>
        </GlassCard>
        ...
        <GlassCard padding="lg" style={{ animation: 'fadeInUp 1.1s ease-out' }}>
          ...
          <p style={explanationStyles}>
            {sandhiData.detailedExplanation}
          </p>
        </GlassCard>
        ...
        <GlassCard padding="lg">
          <h3 style={questionTitleStyles}>
            🔮 Ask the Guru about Sandhi
          </h3>

          <div style={inputContainerStyles}>
            <textarea
              style={inputStyles}
              placeholder="E.g., Explain Vriddhi Sandhi with examples..."
              value={questionInput}
