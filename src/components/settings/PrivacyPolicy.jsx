      ...
      <div style={contentStyles} className="hide-scrollbar">
        <GlassCard padding="lg">
          ...
          <div style={{ ...sectionStyles, marginTop: theme.spacing.xl }}>
            ...
            <p style={textStyles}>
              This app uses <strong>OpenRouter API</strong> to provide AI reasoning and vision analysis. When you chat or upload an image, the content is sent to OpenRouter's servers for processing. No personal identifiers are linked to these requests by the app.
            </p>
          </div>
